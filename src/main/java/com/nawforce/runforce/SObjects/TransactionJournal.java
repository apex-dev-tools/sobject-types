...
public class TransactionJournal extends SObject {
	...
	public LoyaltyProgramPartnerLedger[] PartnerLedgerToJournal;
	public ProcessInstance[] ProcessInstances;
	public ProcessInstanceHistory[] ProcessSteps;
	public RecordAlert[] RecordAlertParent;
	public RecordAlert[] RecordAlertWhat;
	public TransactionJournal[] RelatedTransaction;
	public GameParticipantReward[] SourceActivities;
	public LoyaltyLedger[] TransactionJournalLedger;
	public Voucher[] VoucherTransactionJournal;

	public TransactionJournal clone$() {throw new java.lang.UnsupportedOperationException();}
	public TransactionJournal clone$(Boolean preserveId) {throw new java.lang.UnsupportedOperationException();}
	public TransactionJournal clone$(Boolean preserveId, Boolean isDeepClone) {throw new java.lang.UnsupportedOperationException();}
	public TransactionJournal clone$(Boolean preserveId, Boolean isDeepClone, Boolean preserveReadonlyTimestamps) {throw new java.lang.UnsupportedOperationException();}
	public TransactionJournal clone$(Boolean preserveId, Boolean isDeepClone, Boolean preserveReadonlyTimestamps, Boolean preserveAutonumber) {throw new java.lang.UnsupportedOperationException();}
}
